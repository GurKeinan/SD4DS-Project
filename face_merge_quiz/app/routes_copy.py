...
#         session['join-random-game'] = True  # CHECK
...
#     if not session.get('join-random-game'):
#         return redirect(url_for('join_random_game'))
...
#     session['upload-image'] = True  # CHECK
...
#     if not session.get('upload-image'):
#         return redirect(url_for('home'))
#     session['waiting-for-other'] = True  # CHECK
...
#
#
# @app.route('/show_merged_image')  # check merged ready condition and load_image
# @login_required
...
#     session['show-merged-image'] = True  # CHECK
#     return render_template('guess_image.html', image_url=merged_image_url, options=options)
#
#
# @app.route('/submit_guess', methods=['POST'])  # if there is no guess or didn't pass merged, go home
# @login_required
# def submit_guess():
#     """
...
#
#
# @app.route('/game_result/<result>')  # submit guess
# @login_required
...
#
#
# @app.route('/game_cancelled')  # cancel game
# @login_required
# def game_cancelled():
